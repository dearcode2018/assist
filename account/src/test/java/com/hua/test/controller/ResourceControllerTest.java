...
public final class ResourceControllerTest extends BaseSpringTest {
	...
	public void testLoadImage() {
		try {
			// 页面/服务 地址
			String url = prefix + "/data/upload/1.png";
			// 请求构建器
			// get 方法
			...
			OutputStream outputStream =new FileOutputStream(ProjectUtil.getAbsolutePath("/doc/download/t2.png", true));
